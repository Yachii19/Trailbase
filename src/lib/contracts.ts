...
export const CERTIFICATE_CONTRACT_ADDRESS = 
  process.env.NEXT_PUBLIC_CERTIFICATE_CONTRACT_ADDRESS || '0x0000000000000000000000000000000000000000';

export const GIG_ESCROW_CONTRACT_ADDRESS = 
  process.env.NEXT_PUBLIC_GIG_ESCROW_CONTRACT_ADDRESS || '0x0000000000000000000000000000000000000000';
